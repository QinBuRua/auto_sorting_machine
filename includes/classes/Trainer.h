...
#ifndef AUTO_SORTING_MACHINE_INCLUDES_CLASSES_TRAINER_H
#define AUTO_SORTING_MACHINE_INCLUDES_CLASSES_TRAINER_H
...
#endif //AUTO_SORTING_MACHINE_INCLUDES_CLASSES_TRAINER_H
